...
public:
   MySerial(StringList &li, bool &d, uint8_t receivePin, uint8_t transmitPin, bool inverse_logic = false);
...
/** Constructor */
MySerial::MySerial(StringList &li, bool &d, uint8_t receivePin, uint8_t transmitPin, bool inverse_logic /*= false*/)
